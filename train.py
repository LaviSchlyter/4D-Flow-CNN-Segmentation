...
from utils import make_dir_safely, generate_experiment_name, checkpoint, iterate_minibatches, setup_scheduler, cut_z_slices, save_results_visualization
import model_zoo
        ...
        for batch in iterate_minibatches(images_tr, labels_tr, config["batch_size"], config):
            ...
            if config["with_validation"]:
                if (step) % config["val_eval_frequency"] == 0:
                    ...
                    utils.make_dir_safely(exp_dir + '/results/')
                ...
                if step % 400 == 0:
                    ...
                    utils.make_dir_safely(exp_dir + '/results/' + 'visualization/' + 'training/')
                    utils.make_dir_safely(exp_dir + '/results/' + 'visualization/' + 'validation/')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_path', type=str, default='config/config_train.yaml', help='Path to configuration YAML file')
